...
//
// GitHub Copilot reads `.github/copilot-instructions.md`. It does not load
// SKILL.md files directly, so this adapter emits a single snippet that lists
// each canonical skill (name + description) for Copilot to consume. The
// consumer's sync script merges the snippet into the hand-edited
// copilot-instructions.md by replacing the marker block.
//
